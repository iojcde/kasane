...
export class SplitText {
  #options = {
    charClass: "split_char",
    wordClass: "split_word",
    lineClass: "split_line",
    globalClass: "split_wrapper",
    emptySpaceName: "split_empty",
  };
  ...
  #getTextContent() {
    this.textContent = this.target.textContent.trim();
  }
